...
public class IterativeFibonacciTest {
    ...
    public void testFib1() {
        ...
        //When & Then
        assertEquals(BigInteger.ONE, iterativeFibonacci.computeFib(operationModel));
    }
    ...
    public void testFib3() {
        ...
        //When & Then
        assertEquals(BigInteger.valueOf(2), iterativeFibonacci.computeFib(operationModel));
    }
    ...
    public void testFib30() {
        ...
        //When & Then
        assertEquals(BigInteger.valueOf(832040), iterativeFibonacci.computeFib(operationModel));
    }
    ...
    public void testFibMinusOne() {
        ...
        try {
            iterativeFibonacci.computeFib(operationModel);
